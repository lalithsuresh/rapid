...
final class DeferredReceiveInterceptor implements ServerInterceptor {
    ...
    private static final String PROBE_METHOD_NAME = MembershipServiceGrpc.METHOD_RECEIVE_PROBE.getFullMethodName();
    ...
    public <ReqT, RespT> ServerCall.Listener<ReqT> interceptCall(final ServerCall<ReqT, RespT> serverCall,
        ...
        if (serverCall.getMethodDescriptor().getFullMethodName().equals(PROBE_METHOD_NAME)) {
            return next.startCall(serverCall, metadata);
        }
